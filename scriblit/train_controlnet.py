			...
			if accelerator.sync_gradients:
				...
				if accelerator.is_main_process:
					if global_step % args.checkpointing_steps == 0:
						...
						write_tb_log(batch["conditioning_pixel_values"][:,3:6,:,:], 'shading', n_img, log_writer, global_step)
						write_tb_log(batch["control_target"][:,3:6,:,:], 'shading_gt', n_img, log_writer, global_step)
