...
# CUDA_VISIBLE_DEVICES=0 python inference.py -n scribblelight_controlnet -data sketchfab -seed 1234
# CUDA_VISIBLE_DEVICES=0 python inference_sketch.py -n scribblelight_controlnet -data paper_bike -seed 1234
...
print("Loading model from %s"%experiment)
print("Loading controlnet from %s"%controlnet_path)
print("Loading unet from %s"%unet_path)
print("Loading vae from %s"%base_model_path)
print("Loading noise scheduler from %s"%base_model_path)
print("Loading image transforms from %s"%base_model_path)
print("Loading conditioning image transforms from %s"%base_model_path)
print("Loading image from %s"%file_path)
print("Loading image transforms from %s"%file_path)
print("Loading conditioning image transforms from %s"%file_path)
print("Loading vae from %s"%file_path)
print("Loading noise scheduler from %s"%file_path)
