...
def make_train_dataset(args):
    ...
    dataset = SyncDataset(args.video_folder + '/train', max_frames=16)
...
def make_test_dataset(args):
    ...
    dataset = SyncDataset(args.video_folder, max_frames=16)
