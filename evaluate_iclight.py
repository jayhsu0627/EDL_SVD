...
for base in base_ids:
    for r in range(1, 61):
        ...
        preds = sorted(glob.glob(os.path.join(root_dir, folder, "iclight*.png")))
...
output_dir = '~/DiffusionMaskRelight/iclight_summary.json'
if mask_evaluation:
    output_dir = '~/DiffusionMaskRelight/iclight_mask_summary.json'
