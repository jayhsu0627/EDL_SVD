...
for base in base_ids:
    for r in range(1, 61):
        ...
        preds = sorted(glob.glob(os.path.join(root_dir, folder, "infer128_*.png")))
...
output_dir = '~/DiffusionMaskRelight/edl_summary.json'
if mask_evaluation:
    output_dir = '~/DiffusionMaskRelight/edl_mask_summary.json'
