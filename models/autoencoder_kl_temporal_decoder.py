...
class AutoencoderKLTemporalDecoderControl(ModelMixin, ConfigMixin):
    r"""
    ...
    def __init__(
        self,
        in_channels: int = 5, # (0.5*mask + 0.5*albedo_gray) ⊕ normal ⊕ depth = 5
        out_channels: int = 5,  # (0.5*mask + 0.5*albedo_gray) ⊕ normal ⊕ depth = 5
